...
const GET_TASKS_API_BASE_URL = "http://get-tasks.ak4t7.shop";
const DELETE_TASK_API_BASE_URL = "http://delete-task.ak4t7.shop";
const CREATE_TASK_API_BASE_URL = "http://add-task.ak4t7.shop";
